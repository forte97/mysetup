	...
	if (display != NULL) {
		...
		if (resm != NULL) {
			...
			if (xrdb != NULL) {
				...
				XRDB_LOAD_COLOR("dwm.color2", tagsnormbordercolor);
				XRDB_LOAD_COLOR("dwm.color2", tagsnormfloatcolor);
				...
				XRDB_LOAD_COLOR("dwm.color0", tag1fgcolor);
				XRDB_LOAD_COLOR("dwm.color2", tag1bgcolor);
				XRDB_LOAD_COLOR("dwm.color0", tag2fgcolor);
				XRDB_LOAD_COLOR("dwm.color4", tag2bgcolor);
				XRDB_LOAD_COLOR("dwm.color0", tag3fgcolor);
				XRDB_LOAD_COLOR("dwm.color5", tag3bgcolor);
				XRDB_LOAD_COLOR("dwm.color0", tag4fgcolor);
				XRDB_LOAD_COLOR("dwm.color7", tag4bgcolor);
				XRDB_LOAD_COLOR("dwm.tags.fg1", tag5fgcolor);
				XRDB_LOAD_COLOR("dwm.tags.bg1", tag5bgcolor);
				XRDB_LOAD_COLOR("dwm.tags.fg1", tag6fgcolor);
				XRDB_LOAD_COLOR("dwm.tags.bg1", tag6bgcolor);
				XRDB_LOAD_COLOR("dwm.tags.fg1", tag7fgcolor);
				XRDB_LOAD_COLOR("dwm.tags.bg1", tag7bgcolor);
				XRDB_LOAD_COLOR("dwm.tags.fg1", tag8fgcolor);
				XRDB_LOAD_COLOR("dwm.tags.bg1", tag8bgcolor);
				XRDB_LOAD_COLOR("dwm.tags.fg1", tag9fgcolor);
				XRDB_LOAD_COLOR("dwm.tags.bg1", tag9bgcolor);
				XRDB_LOAD_COLOR("dwm.color0", layoutfgcolor);
				XRDB_LOAD_COLOR("dwm.color8", layoutbgcolor);

				XRDB_LOAD_COLOR("dwm.color2", tag1normfgcolor);
				XRDB_LOAD_COLOR("dwm.color0", tag1normbgcolor);
				XRDB_LOAD_COLOR("dwm.color4", tag2normfgcolor);
				XRDB_LOAD_COLOR("dwm.color0", tag2normbgcolor);
				XRDB_LOAD_COLOR("dwm.color5", tag3normfgcolor);
				XRDB_LOAD_COLOR("dwm.color0", tag3normbgcolor);
				XRDB_LOAD_COLOR("dwm.color7", tag4normfgcolor);
				XRDB_LOAD_COLOR("dwm.color0", tag4normbgcolor);
				XRDB_LOAD_COLOR("dwm.tags.norm.fg5", tag5normfgcolor);
				XRDB_LOAD_COLOR("dwm.tags.norm.bg5", tag5normbgcolor);
				XRDB_LOAD_COLOR("dwm.tags.norm.fg6", tag6normfgcolor);
				XRDB_LOAD_COLOR("dwm.tags.norm.bg6", tag6normbgcolor);
				XRDB_LOAD_COLOR("dwm.tags.norm.fg7", tag7normfgcolor);
				XRDB_LOAD_COLOR("dwm.tags.norm.bg7", tag7normbgcolor);
				XRDB_LOAD_COLOR("dwm.tags.norm.fg8", tag8normfgcolor);
				XRDB_LOAD_COLOR("dwm.tags.norm.bg8", tag8normbgcolor);
				XRDB_LOAD_COLOR("dwm.tags.norm.fg9", tag9normfgcolor);
				XRDB_LOAD_COLOR("dwm.tags.norm.bg9", tag9normbgcolor);
